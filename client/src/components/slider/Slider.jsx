...
const Slider = () => {
  ...
  const handleClick = (direction) => {
    ...
    direction === "left"
      ? setSlideIndex((slideIndex) => (slideIndex === 0 ? sliderItems.length-1 : slideIndex - 1))
      : setSlideIndex((slideIndex) => (slideIndex === sliderItems.length-1 ? 0 : slideIndex + 1));
  };
  return (
